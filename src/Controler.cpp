...
void Controler::setBottomBar(){
	Sprite* sprite;
	sprite = new Sprite("assets/ALL_OFF.png", stage.screenWidth/2 - 400, stage.screenHeight - 40);
	bottomBar.push_back(sprite);
	sprite = new Sprite("assets/SPEED_ON.png", stage.screenWidth/2 - 400, stage.screenHeight - 40);
	bottomBar.push_back(sprite);
	sprite = new Sprite("assets/SHIELD_ON.png", stage.screenWidth/2 - 400, stage.screenHeight - 40);
	bottomBar.push_back(sprite);
	sprite = new Sprite("assets/SHOOT_ON.png", stage.screenWidth/2 - 400, stage.screenHeight - 40);
	bottomBar.push_back(sprite);
}
