...
void Entity::setXVel(int xVel) { this->xVel = xVel; }

void Entity::setYVel(int yVel) { this->yVel = yVel; }
...
void Entity::setLife(int life) { this->life = life; }

int Entity::getXVel() { return xVel; }

int Entity::getYVel() { return yVel; }

SDL_Rect Entity::getBox() { return Box; }

bool Entity::onAnimation(Timer timer) { return true; }
...
int Entity::EntityType() { return type; }
